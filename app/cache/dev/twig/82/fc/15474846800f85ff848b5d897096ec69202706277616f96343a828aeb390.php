...
/* CroisiereBundle:PhotoTypeCabine:index.html.twig */
class __TwigTemplate_82fc15474846800f85ff848b5d897096ec69202706277616f96343a828aeb390 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>PhotoTypeCabine list</h1>
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("phototypecabine_show", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
            echo "\">";
        ...
        <li>
            <a href=\"";
        // line 36
        echo $this->env->getExtension('routing')->getPath("phototypecabine_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "CroisiereBundle:PhotoTypeCabine:index.html.twig";
    }
